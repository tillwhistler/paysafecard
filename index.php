...
<body>
    <header class="header-app">
        <div class="header-brand">
            <img src="logo.svg" alt="Logo" height="38" class="header-logo">
            <span class="brand-title">PSC Rewards</span>
        </div>
    ...
    <footer>
        <div class="footer-app">
            <span>kostenlose-paysafecard.com © <?=date('Y')?> | <a href="mailto:support@kostenlose-paysafecard.com">Support</a></span>
        </div>
    </footer>
